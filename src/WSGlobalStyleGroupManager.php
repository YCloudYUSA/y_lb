 ...
 * @see plugin_api
 */
class WSGlobalStyleGroupManager extends DefaultPluginManager implements WSGlobalStyleInterface {
  ...
  public function __construct(ModuleHandlerInterface $module_handler, CacheBackendInterface $cache_backend) {
    ...
    $this->setCacheBackend($cache_backend, 'ws_global_style_group', ['ws_global_style_group']);
    $this->alterInfo('ws_global_style_group');
  }
  ...
  protected function getDiscovery() {
    if (!isset($this->discovery)) {
      $this->discovery = new YamlDiscovery('ws_global_style_group', $this->moduleHandler->getModuleDirectories());
