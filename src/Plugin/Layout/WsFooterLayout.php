...
/**
 * A custom layout for the WS Footer section.
 */
class WsFooterLayout extends LayoutDefault implements ContainerFactoryPluginInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    $form['wrapper_classes'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Additional wrapper classes for footer'),
      '#default_value' => $this->configuration['wrapper_classes'],
      '#description' => $this->t('Additional wrapper classes for footer. Type as many as you want but remember to separate them by using a single space character.'),
    ];
