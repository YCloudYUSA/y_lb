 ...
 * @Block(
 *   id = "ws_site_name",
 *   admin_label = @Translation("Website Name Block"),
 *   category = @Translation("Common blocks")
 * )
 */
class SiteNameBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new WebsiteNameBlock instance.
   *
